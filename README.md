...
For updates and events, you should join the [Telegram!](https://t.me/deltaclouds)
...
You can also watch the [Video Tutorial!](https://t.me/deltaclouds)
...
**NOTE:** You are __NOT__ supposed to run `build.bat`! Please read the instructions. I will not help if your bug report/issue is "main.py will not open".
...
Additionally, you can donate to me! See my [donations page](https://t.me/deltaclouds), always appreciated!
